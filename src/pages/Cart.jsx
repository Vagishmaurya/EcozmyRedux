...
const Cart = () => {
  ...
  return (
    <div className="mb-10">
      {cart.length > 0 ? (
        <div className="flex flex-col md:flex-row lg:flex-row justify-center max-[1300px] mx-auto gap-x-5">
          {/* Cart Item  */}
          <div className="w-11/12 md: w-[60%]lg:w-[60%] flex flex-col p-2">
          ...
          {/* Summary */}
          <div className="w-11/12 md:w-[40%] lg:w-[40%] mt-5 flex flex-col items-center">
            <div className="flex flex-col h-[100%] justify-between p-4 gap-5 my-14">
